document.addEventListener("DOMContentLoaded", () => {
    ...
    function UserClick(e) {
        if(e.target.className == "lis__word") {
            let selectedQuestion = document.querySelector(".lis__word--selected");
    ...
    function DisableQuestion(question){
        question.classList.remove("lis__word--selected");
        question.children[1].classList.remove("flip-vertically");
        question.nextElementSibling.classList.remove("lis__description--selected");
    }

    function EnableQuestion(question){
        question.classList.add("lis__word--selected");
        question.children[1].classList.add("flip-vertically");
        question.nextElementSibling.classList.add("lis__description--selected");
    }
